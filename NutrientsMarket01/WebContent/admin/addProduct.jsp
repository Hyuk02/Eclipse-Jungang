...
<script src ="../resources/js/validation.js?ver=1"></script>
<body>
		...
		<form name="newProduct" action="./processAddProduct.jsp" 
		 class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<textarea name="description" id="description" cols="50" rows="2" class="form-control" required></textarea>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-3">
					...
					<%
					sql="select brandName from brand order by seq";
