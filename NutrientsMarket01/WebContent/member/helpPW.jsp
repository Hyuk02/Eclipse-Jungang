...
<script>
				function findPhone() {
					...
					window.open("process_helpPW.jsp?phone="+phone+"&id="+id);
				}
				
				function findEmail() {
					var id = document.getElementById("id").value;
					var email = document.getElementById("email").value;
					window.open("process_helpPW.jsp?email="+email+"&id="+id);
				}
</script>
...
<div class="container">
		<form name=helpMember class="form-horizontal" method="post" onsubmit="return checkForm()" >
				...
				<div class="form-group row list-group-item list-group-item-secondary ">
					...
					<label class="col-sm-2">I&nbsp;&nbsp;D</label>
						<input name="id" id="id" class="form-control col-sm-5" maxlength="10" required>
				...
				<div class="form-group row list-group-item list-group-item-warning" id="hidden_phone" hidden>
				...
				<div class="form-group row list-group-item list-group-item-warning" id="hidden_email" hidden>
